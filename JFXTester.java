...
import javafx.event.ActionEvent;		//Not currently used, because when using lambdas the type is implied correctly.
import javafx.event.EventHandler;		//Same as above.
...
public class JFXTester extends Application {
	...
	public void start(Stage primaryStage) throws Exception {	//Stages is the window, scene is the... Scene?
		...
		Button clickButton = new Button("click me");	//Size of the button is relative to the text it has. Can also have an image.
